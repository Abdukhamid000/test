<template>
  <section class="relative bg-gray-100 border-b font-poppins dark:bg-gray-800 dark:border-gray-800">
    <div class="container mx-auto" x-data="{open:false}">
        ...
        <div class="flex items-center justify-between w-full px-4 py-2 lg:px-2">
          ...
          <div class="items-center justify-end hidden lg:flex dark:text-gray-400">
            ...
            <span
              ...
              href=""
              class="flex items-center relative dark:text-gray-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
      ...
      <!-- Mobile Sidebar -->
      <div
        class="fixed inset-0 w-full bg-gray-800 opacity-25 lg:hidden dark:bg-gray-400"
        :class="{
      ...
      ></div>
      <div
        class="absolute inset-0 z-10 h-screen p-3 text-gray-700 duration-500 transform shadow-md dark:bg-gray-800 bg-cyan-50 w-80 lg:hidden lg:transform-none lg:relative"
        :class="{
          'translate-x-0 ease-in-opacity-100': open === true,
          '-translate-x-full ease-out opacity-0': open === false
        }"
      >
        <div class="flex justify-between">
          ...
          <button
            class="p-2 rounded-md hover:text-cyan-300 lg:hidden dark:text-gray-300"
            @click="open = false"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <CModal :show="isModalShown" @close="isModalShown = false" modal-class="overflow-y-auto h-full">
      <ShoppingCart />
    </CModal>
  </section>
</template>
