  ...
  <div class="z-10 w-full p-10 bg-gray-100 dark:bg-gray-900 h-100">
    ...
    <form action="" class="mt-6" @submit.prevent="handleSubmit">
        ...
        <div>
          ...
          <div class="relative flex items-center mt-2">
            ...
            <svg
              ...
              width="16"
              height="16"
              class="absolute right-0 mr-3 dark:text-gray-300"
              fill="currentColor"
              viewBox="0 0 16 16"
            >
              <path
      ...
      <div class="mt-4 text-right">
        <a href="#" class="text-sm font-semibold text-blue-700 hover:underline">forgot password?</a>
      </div>
      <button
      ...
      <p class="mt-6 text-gray-700 dark:text-gray-300">
        Need an account?
        <a href="#" class="font-semibold text-blue-500 hover:text-blue-700"> Create an account </a>
      </p>
    </form>
  </div>
</template>
